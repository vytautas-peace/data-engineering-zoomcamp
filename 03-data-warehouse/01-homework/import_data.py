...
BUCKET_NAME = "dez-03-dw-hw-bucket"

# If you authenticated through the GCP SDK you can comment out these two lines
# CREDENTIALS_FILE = "gcs.json"
#client = storage.Client.from_service_account_json(os.environ["CREDENTIALS_FILE"])
# If commented initialize client with the following
# client = storage.Client(project='zoomcamp-mod3-datawarehouse')

# 1. Parse the env var into a Python dictionary
credentials_dict = json.loads(os.environ["CREDENTIALS_FILE"])
# 2. Create credentials object from the dictionary
credentials = service_account.Credentials.from_service_account_info(credentials_dict)
# 3. Pass the credentials object to the client
